  ...
  try {
    ...
    return NextResponse.json({
      ...
      personalization: {
        ...
        energy: personalization.userState.energy,
        mood: personalization.userState.mood,
        energySource: personalization.userState.energySource,
        moodSource: personalization.userState.moodSource,
        stateUpdatedAt: personalization.userState.stateUpdatedAt,
